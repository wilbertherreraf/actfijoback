...
public class AfTipoCambio {
    ...
    public AfTipoCambio(Integer idTipoCambio, String catMoneda, Date fecha, BigDecimal cambio, String estado, Integer idTransaccion, Date txFchIni, Integer txUsrIni, String txHostIni) {
        this.idTipoCambio = idTipoCambio;
