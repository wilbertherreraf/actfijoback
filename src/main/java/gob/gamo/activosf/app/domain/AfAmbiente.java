...
public class AfAmbiente {
    ...
    public AfAmbiente(Integer idAmbiente, String catTipoAmbiente, String catEdificio, String catPiso, String nombre, String estado, Integer idTransaccion, Date txFchIni, Integer txUsrIni, String txHostIni) {
