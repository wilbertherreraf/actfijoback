...
public class AfAlmacen {
    ...
    public AfAlmacen(Integer idAlmacen, String nombre, boolean esValorado, String estado, Integer idTransaccion, Date txFchIni, Integer txUsrIni, String txHostIni) {
        this.idAlmacen = idAlmacen;
        this.nombre = nombre;
