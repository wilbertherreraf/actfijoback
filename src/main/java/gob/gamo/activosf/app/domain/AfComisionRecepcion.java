...
public class AfComisionRecepcion {
    ...
    public AfComisionRecepcion(Integer idComisionRecepcion, TxUsuario idUsuario, String estado, Integer idTransaccion, Date txFchIni, Integer txUsrIni, String txHostIni) {
        this.idComisionRecepcion = idComisionRecepcion;
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idComisionRecepcion == null && other.idComisionRecepcion != null) || (this.idComisionRecepcion != null && !this.idComisionRecepcion.equals(other.idComisionRecepcion))) {
            return false;
        }
        return true;
    }
