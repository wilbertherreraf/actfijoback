...
public class AfAltaMaterial {
    ...
    public AfAltaMaterial(Integer idAltaMaterial, Integer correlativo, Integer gestion, String catTipoAltaMaterial, Date fechaAlta, String catEstadoAltaMaterial, String estado, Integer idTransaccion, Date txFchIni, Integer txUsrIni, String txHostIni) {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idAltaMaterial == null && other.idAltaMaterial != null) || (this.idAltaMaterial != null && !this.idAltaMaterial.equals(other.idAltaMaterial))) {
            return false;
        }
        return true;
    }
