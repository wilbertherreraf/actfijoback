...
public class AfTransferenciaAsignacion {
    ...
    public AfTransferenciaAsignacion(
            ...
            Integer correlativo,
            Integer gestion,
            String catTransferenciaAsignacion,
            Date fechaTransferencia,
            String catTipoAsignacion,
            String catEstadoUso,
            String catCentroCostoDestino,
            TxUsuario idUsuarioDestino,
            String estado,
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idTransferenciaActivoFijo == null && other.idTransferenciaActivoFijo != null)
                || (this.idTransferenciaActivoFijo != null
                        && !this.idTransferenciaActivoFijo.equals(other.idTransferenciaActivoFijo))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "gob.gamo.activosf.app.domain.AfTransferenciaAsignacion[ idTransferenciaActivoFijo="
