...
public class AfMaterialProveedor {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idMaterialProveedor == null && other.idMaterialProveedor != null)
                || (this.idMaterialProveedor != null && !this.idMaterialProveedor.equals(other.idMaterialProveedor))) {
            return false;
        }
        return true;
    }
