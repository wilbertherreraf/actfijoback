...
public class LazyLoadingUtil {
    ...
    public static void load(Object o, String... atributos) {
        ...
        for (String atributo : atributos) {
            try {
                Object atr = o.getClass()
                        .getMethod(atributo, null)
                        .getDefaultValue(); //  PropertyUtils.getProperty(o, atributo);
                ...
                new DataException(
                        "No se pudo realizar el LazyLoading de la clase: " + o.getClass() + " para el atributo: "
                                + atributo,
                        e);
            }
        }
