...
public class TransactionUtil {
    ...
    public static void setInitTransactionData(Object e, TxTransaccion tx) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Excepción al intentar llenar los atributos transaccionales de la entidad: " + clazz
                            + " ¿Esta seguro que esta entidad tiene los atributos transaccionales?",
                    ex);
        }
    }

    public static void setUpdateTransactionData(Object e, TxTransaccion tx) {
        Class clazz = e.getClass();
        try {
            Method setIdTransaccion = clazz.getMethod("setIdTransaccion", int.class);
            setIdTransaccion.invoke(e, tx.getIdTransaccion().intValue());
