...
public class AgrupadorReporteVo implements java.io.Serializable {
	...
	public final static SimpleDateFormat SD_NORMAL = new SimpleDateFormat("dd/MM/yyyy");
	public final static SimpleDateFormat SD_EXTENDIDO = new SimpleDateFormat("dd 'de' MMMMM 'de' yyyy");
