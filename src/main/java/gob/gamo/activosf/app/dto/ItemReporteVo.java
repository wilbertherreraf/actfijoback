...
public class ItemReporteVo implements java.io.Serializable {
    ...
    public void agruparItemReporteVo(ItemReporteVo itemReporteVo) {
        ...
        actualizacionDepreciacionAcumulada =
                actualizacionDepreciacionAcumulada.add(itemReporteVo.actualizacionDepreciacionAcumulada);
    }
    ...
    public void setPorcentajeDepreciacionAnual(BigDecimal porcentajeDepreciacionAnual) {
