...
public enum ReporteActivoFijoEnum {
	...
	INVENTARIO_AGRUPADO_POR_CODIGO_CONTABLE("/Rep11_AGRUPADO_POR_CODIGO_CONTABLE.xlsx", "Inventario agrupado por Código Contable"),
	INVENTARIO_AGRUPADO_POR_PARTIDA_PRESUPUESTARIA("/Rep12_AGRUPADO_POR_PARTIDA_PRESUPUESTARIA.xlsx", "Inventario agrupado por Partida Presupuestaria"),
