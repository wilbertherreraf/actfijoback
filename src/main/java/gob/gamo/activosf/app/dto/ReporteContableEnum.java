...
public enum ReporteContableEnum {
	INVENTARIO_ORDENADO_CODIGO_ACTIVO("/Rep1_INVENTARIO_ORDENADO_CODIGO_ACTIVO.xlsx", "Inventario ordenado por Código de Activo"),
	...
	INVENTARIO_AGRUPADO_POR_CODIGO_CONTABLE("/Rep4_AGRUPADO_POR_CODIGO_CONTABLE.xlsx", "Inventario agrupado por Código Contable"),
	INVENTARIO_AGRUPADO_POR_PARTIDA_PRESUPUESTARIA("/Rep5_AGRUPADO_POR_PARTIDA_PRESUPUESTARIA.xlsx", "Inventario agrupado por Partida Presupuestaria"),
	...
	INVENTARIO_ORDENADO_CODIGO_ACTIVO_REVALUO("/Rep1_1_INVENTARIO_ORDENADO_CODIGO_ACTIVO_REVALUO.xlsx", "Inventario ordenado por Código de Activo con Revalúo"),
