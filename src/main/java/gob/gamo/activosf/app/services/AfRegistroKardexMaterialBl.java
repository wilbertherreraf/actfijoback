...
public class AfRegistroKardexMaterialBl {
    ...
    public void mergeAfRegistroKardexMaterial(AfRegistroKardexMaterial afRegistroKardexMaterial, UserRequestVo userRequestVo) {
    ...
    public void persistAfRegistroKardexMaterial(AfRegistroKardexMaterial afRegistroKardexMaterial, UserRequestVo userRequestVo) {
    	TxTransaccion txTransaccion = txTransaccionBl.generateTxTransaccion(userRequestVo);
        afRegistroKardexMaterialRepository.save(afRegistroKardexMaterial);
    }
    
    public void deleteAfRegistroKardexMaterial(AfRegistroKardexMaterial afRegistroKardexMaterial, UserRequestVo userRequestVo) {
    	TxTransaccion txTransaccion = txTransaccionBl.generateTxTransaccion(userRequestVo);
        afRegistroKardexMaterialRepository.delete(afRegistroKardexMaterial);
    }
    
    public List<AfRegistroKardexMaterial> findAllActivesAfRegistroKardexMaterialByKardexMaterial(AfKardexMaterial afKardexMaterial) {
        return afRegistroKardexMaterialRepository.findAllActivesByAfKardexMaterial(afKardexMaterial);
    }
    
    public List<AfRegistroKardexMaterial> findAllActivesConSaldoByAfMaterialPorGestionOrdenadoPeps(AfKardexMaterial afKardexMaterial, Integer gestion) {
        return afRegistroKardexMaterialRepository.findIngresoInicialConSaldoByAfKardexMaterialPorGestionOrdenadoPeps(afKardexMaterial, gestion);
    }
