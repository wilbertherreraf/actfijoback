...
public abstract class AbstractDao<E> {
    ...
    public AbstractDao(Class<E> clazz){
        ...
        try {
			...
			throw new DataException("Excepción al intentar obtener la llave primaria de la entidad: " + clazz + 
					" . ¿La entidad tiene un atributo anotado con '@Id'?", ex);
		} 
    }
    ...
    public void delete(E e, TxTransaccion tx){
    	try {
			...
			throw new DataException("Excepción al intentar establecer el estado de la entidad: " + clazz + 
					" . ¿La entidad tiene el metodo 'setEstado(String)' ?", ex);
		}
    }
    ...
    public void merge(E e, TxTransaccion tx, boolean refresh){
    	...
    	try {
			...
			throw new DataException("Excepción al intentar obtener la llave primaria de la entidad: " + clazz + 
					" . ¿La entidad tiene un atributo anotado con '@Id'? Entidad: " + e, ex);
		}
		E other = findByPk(pk);
		if (other != null) {
