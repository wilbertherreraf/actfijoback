...
public class AfSolicitudBl {
    ...
    public List<AfSolicitud> findAllActivesByGestionAndCatTipoSolicitudYUsuario(Integer gestion, String catTipoSolicitud, TxUsuario idUsuario) {
        return afSolicitudRepository.findAllActivesByGestionAndCatTipoSolicitudYUsuario(gestion, catTipoSolicitud, idUsuario);
    }
