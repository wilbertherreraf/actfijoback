...
@Slf4j
public class DepCalcs {
    /*---------------------------------*/
    /* ------- SL Depreciation ------- */
    /*---------------------------------*/
    public static List<DepYear> CalcSL(Asset asset) {
        List<DepYear> years = new ArrayList<DepYear>();
    ...
    public static List<DepYear> CalcSYD(Asset asset) {
        ...
        double fAD = 0;
        double fBasis = asset.PurchasePrice - asset.ResidualValue;
        int iYearsLeft = asset.UsefulLife;
        int iSigma = (int) (asset.UsefulLife * (((double) asset.UsefulLife + (double) 1) / (double) 2));
    ...
    public static List<DepYear> CalcMacrsHY(Asset asset) {
        ...
        double[] HYtable3 = {33.33, 44.45, 14.81, 7.41};

        double[] HYtable5 = {20.00, 32.00, 19.20, 11.52, 11.52, 5.76};

        double[] HYtable7 = {14.29, 24.49, 17.49, 12.49, 8.93, 8.92, 8.93, 4.46};

        double[] HYtable10 = {10.00, 18.00, 14.40, 11.52, 9.22, 7.37, 6.55, 6.55, 6.56, 6.55, 3.28};
        ...
        double[] HYtable20 = {
            3.750, 7.219, 6.677, 6.177, 5.713, 5.285, 4.888, 4.522, 4.462, 4.461, 4.462, 4.461, 4.462, 4.461, 4.462,
            4.461, 4.462, 4.461, 4.462, 4.461, 2.231
        };

        // calculate the basis given SS179
        double fBasis = asset.PurchasePrice - asset.Section179;

        for (iYear = 0; iYear <= asset.getTaxLife(); iYear++) {
            DepYear oYear = new DepYear();
            oYear.Year = iYear;

            switch (asset.getTaxLife()) {
                case 3:
            ...
            if (iYear == 0) oYear.Expense += asset.Section179;

            // Adjust for Rounding (in last year)
            if ((fAD + oYear.Expense) > asset.PurchasePrice) oYear.Expense = asset.PurchasePrice - fAD;
    ...
    public static List<DepYear> CalcMacrsMQ(Asset asset) {
        ...
        double[][] MQtable20 = {
            {
                6.563, 7.000, 6.482, 5.996, 5.546, 5.130, 4.746, 4.459, 4.459, 4.459, 4.459, 4.460, 4.459, 4.460, 4.459,
                4.460, 4.459, 4.460, 4.459, 4.460, 0.557
            },
            {
                4.688, 7.148, 6.612, 6.116, 5.658, 5.233, 4.841, 4.478, 4.463, 4.463, 4.463, 4.463, 4.463, 4.463, 4.462,
                4.463, 4.462, 4.463, 4.462, 4.463, 1.673
            },
            {
                2.813, 7.289, 6.742, 6.237, 5.769, 5.336, 4.936, 4.566, 4.460, 4.460, 4.460, 4.460, 4.461, 4.460, 4.461,
                4.460, 4.461, 4.460, 4.461, 4.460, 2.788
            },
            {
                0.938, 7.430, 6.872, 5.880, 5.439, 5.031, 4.654, 4.458, 4.458, 4.458, 4.458, 4.458, 4.458, 4.458, 4.458,
                4.458, 4.458, 4.459, 4.458, 4.459, 3.901
            }
        };
        ...
        // figure out the quarter by ignoring the fraction through casting to a short
        // int
        iQtr = (short) (UtilsDate.getCuatrimestre(asset.PurchaseDate) - 1);
    ...
    public static void main(String[] args) {
        int iQtr = (short) (1 / 12);
        System.out.println("1: " + iQtr + " " + (double) (1 / 12));
        iQtr = (short) (5 / 12);
        BigDecimal d = BigDecimal.valueOf(((20 * 12) / 12.0));
        System.out.println("9: " + iQtr + " " + (double) (5 / 12) + " a:" + d);
        iQtr = (short) (9 / 12);
        System.out.println("9: " + iQtr + " " + (double) (9 / 12));
        iQtr = (short) (12 / 12);
        System.out.println("12: " + iQtr + " " + (double) (11 / 12));
        ...
        System.out.println("MQtable20: " + MQtable20[0][1] + " " + MQtable20[1][1]);
    }
}
